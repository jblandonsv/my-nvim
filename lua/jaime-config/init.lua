...
-- require("dap-python").setup("/Users/jaime/.pyenv/versions/debug/bin/python")
require("dap-python").setup("/Users/jaime/.pyenv/versions/theglew-backend/bin/python")
require("toggleterm").setup({})
require("jaime-config.nvim-dap-js")
require("jaime-config.solidity")
require("jaime-config.lsp_info")
require("jaime-config.godot")
